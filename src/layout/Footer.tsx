      ...
      <div>
        <footer className="bg-green-600">
          <div className=" container mx-auto">
            <div className="columns-3 footer py-10  text-white">
              <div>
          ...
          <div className="bg-green-700 text-center text-white p-5 text-base">
            <div className="container mx-auto">
              <p>Copyright &#169; 2023 Green Book House. All rights reserved by GBH.</p>
            </div>
          </div>
        </footer>
      </div>
